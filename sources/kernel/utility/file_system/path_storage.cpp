...
// const std::string&
// utils::PathStorage::getFilePath(const std::string& a_file_name) const
// {
//     return m_files_paths.find(a_file_name)->second;
// }

// const std::string&
// utils::PathStorage::getFolderPath(const std::string& a_folder_name) const
// {
...
// const std::string&
// utils::PathStorage::addFile(const std::string& a_parent_name,
...
// const std::string&
// utils::PathStorage::addFolder(const std::string& a_parent_name,
...
// void
// utils::PathStorage::touchFolder(const std::string& a_folder_path)
// {
...
// // bool
// // utils::PathStorage::removeFolderNonstatic(
...
// //     {
// //         CONTEXT_ERROR(a_context,
// //                       "The folder being deleted is not in the path
// storage, "
// //                       "folder name: '%s'.",
// //                       a_folder_name);
// //     }
...
// // bool
// // utils::PathStorage::clearFolderNonstatic(std::string_view a_folder_name,
...
// //         if (result)
// //         {
// //             auto opt_path = touchFolderNonstatic(a_folder_name,
// &a_context);
...
// // void
// // utils::PathStorage::addContentToPathsNonstatic(std::string_view a_path,
...
// // utils::PathStorage::getContentNonstatic(std::string_view a_path,
// //                                        ObjectType a_object_type,
...
// //     {
// //         result =
// getContentImpl(std::filesystem::directory_iterator(a_path),
// //                                 a_object_type);
// //     }
// //     else
// //     {
...
// // utils::PathStorage::getContentMapNonstatic(std::string_view a_path,
// //                                           ObjectType a_object_type,
// //                                           LevelType a_level_type) noexcept
// // {
