...
gpu::hard::Device::Device(vk::PhysicalDevice& a_myself)
    : vk::PhysicalDevice(a_myself)
{
...
std::string
gpu::hard::Device::getName() const
{
    return getProperties().deviceName;
}

gpu::type::MemoryTypeIndex
gpu::hard::Device::getMemoryTypeIndex(type::MemoryTypeBits a_type_filter,
                                      vk::MemoryPropertyFlags a_properties)
{
         ...
         i++)
    {
        ...
        {
            LOG_SPAM("Memory type index %d", i);
            return i;
        }
    }
...
void
gpu::hard::Device::printFamilyProperty(core::Command& a_command)
{
