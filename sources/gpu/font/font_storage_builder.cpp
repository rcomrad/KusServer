...
// void
// gpu::font::FontStorageBuilder::push()
// {
// }

gpu::font::FontStorage
gpu::font::FontStorageBuilder::collapse(sprite::SpriteStorage& builder)
{
    ...
    {
        std::unordered_map<char, int> char_sprites;
        for (char c = CHAR_FROM; c < CHAR_TO; ++c)
        {
            ///......
        }
