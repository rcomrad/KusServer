#ifndef BASIC_SCENE_2D_HPP
#define BASIC_SCENE_2D_HPP
#include <memory>
#include <string>
#include <tuple>
#include <vector>
...
class BasicScene2D : public BasicScene
{
public:
...
private:
    std::vector<std::unique_ptr<Drawable2D_P1UV1_TRS>> drawables_2d_p1uv1_trs;
    DrawableSystem2D_P1UV1_TRS m_drawable_system;
};

}; // namespace kusengine::render

#endif // BASIC_SCENE_2D_HPP
