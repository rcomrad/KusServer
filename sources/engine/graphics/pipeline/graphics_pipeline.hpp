...
#include "engine/graphics/shaders/shaders/shader.hpp"
                         ...
                         const vk::RenderPass& render_pass)
{
    ...
    vertex_shader_path +=
        "engine/graphics/shaders/compiled/vertex_shader.vert.spv";

    std::string fragment_shader_path = sources_path.value().data();
    fragment_shader_path +=
        "engine/graphics/shaders/compiled/fragment_shader.frag.spv";
