...
TEST_F(UTestString, test_slice_empty_input)
{
    char s[] = "";
    char buffer[256];
    auto result = utils::Slicer::safeProcess(s, buffer, ", ", "!");
...
TEST_F(UTestString, test_slice_into_old_buffer)
{
    ...
    auto result   = utils::Slicer::process(s, "AZ,.- !");
...
TEST_F(UTestString, get_lines)
{
    ...
    auto lines       = utils::Parser::getLines(data);
...
TEST_F(UTestString, get_words)
{
    ...
    auto words       = utils::Parser::getWords(data);
