...
text::Value::operator int() const noexcept
{
    return std::stoi(str);
}

text::Value::operator float() const noexcept
{
    return std::stof(str);
}

text::Value::operator bool() const noexcept
{
    bool result     = false;
...
text::Value::operator std::string() const noexcept
{
    return str;
}

text::Value::operator dom::Pair<float>() const noexcept
{
...
text::Value::Type
text::Value::getType() const noexcept
{
