...
test::Tester::run(data::Submission&& aSubmission) noexcept
{
    ...
    std::string curPath = text::Path::getPathUnsafe("problem");
    ...
    {
        checkerPath = text::Path::getPathUnsafe("checker") + checkerPath;
    }

    auto workDir   = text::Path::getPathUnsafe("working_directory");
